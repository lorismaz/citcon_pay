...
RSpec.describe CitconPay::Client, :configure_citcon do
  ...
  describe "#initialize" do
    ...
    it "validates configuration on initialization" do
      ...
      }.to raise_error(CitconPay::ConfigurationError)
    end
  end
  ...
  describe "error handling" do
    ...
    it "raises ValidationError for 400 status" do
      ...
      expect {
        client.post("charges", body: {})
      }.to raise_error(CitconPay::ValidationError, "Invalid parameters")
    end
    ...
    it "raises NotFoundError for 404 status" do
      ...
      }.to raise_error(CitconPay::NotFoundError, "Transaction not found")
    end
    ...
    it "raises RateLimitError for 429 status" do
      ...
      expect {
        client.post("charges", body: {})
      }.to raise_error(CitconPay::RateLimitError, "Rate limit exceeded")
    end
    ...
    it "raises ServerError for 500 status" do
      ...
      expect {
        client.post("charges", body: {})
      }.to raise_error(CitconPay::ServerError, "Internal server error")
    end
    ...
    it "clears access token on 401 error" do
      ...
      }.to raise_error(CitconPay::AuthenticationError)
